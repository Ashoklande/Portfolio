    ...
    <>
      <div  className=" fixed top-0 left-0 right-0 flex justify-between bg-slate-100 items-center px-10">
        ...
        <h2 className="text-4xl font-medium flex items-center">
          <img
            className="object-cover max-sm:h-10 h-24"
        ...
        <p onClick={()=>setdarkmodeon(prev=>!prev)} className="text-5xl flex cursor-pointer">
         ...
         <button className="max-sm:text-xl text-2xl">Contact</button>
      ...
      <div className="flex gap-3 w-full justify-center  fixed bottom-2">
       ...
       <a className="text-5xl rounded-full bg-white px-1 cursor-pointer" href="#home"> <i className="ri-home-2-line"></i></a>
          <img
            onClick={() =>
              window.open("https://www.instagram.com/ashoklande73/?hl=en")
            }
            className="h-14 cursor-pointer object-center rounded-full"
          ...
          <img
            ...
            className="object-cover cursor-pointer object-center h-14 rounded-full"
