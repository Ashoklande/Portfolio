  ...
  return (
    <div id='contact'
     className={` ${darkmodeon?'text-white':''} 2xl:px-20 px-15 h-screen py-28  items-center  flex flex-col gap-5 p-5 `}>
        ...
        <p className='md:text-xl md:max-w-[40%] md:mt-6 font-mono text-lg'> I'd love to hear from you! If you any questions,comment and feedback,please use form below.</p>
